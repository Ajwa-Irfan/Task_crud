                    ...
                    <form action="{{ route('tasks.store') }}" method="POST">
                        ...
                        <div class="row g-4">
                            <div class="col-12">
                                ...
                                <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" value="{{ old('title') }}" placeholder="Enter task title...">
                                @error('title')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-12">
                                <label class="form-label">Description</label>
                                <textarea name="description" class="form-control" rows="4" placeholder="Task details...">{{ old('description') }}</textarea>
                            </div>
                            <div class="col-md-6">
